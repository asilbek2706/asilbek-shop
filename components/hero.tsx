...
const Hero = () => {
    return (
        <section className='body-font bg-white text-gray-400'>
                ...
                <div className='flex flex-col items-center text-center md:w-1/2 md:items-start md:pl-16 md:text-left lg:grow lg:pl-24'>
                    ...
                    <div className='flex w-full items-end justify-center md:justify-start'>
                        <div className='relative mr-4 w-2/4 lg:w-full xl:w-1/2'>
                            <label htmlFor='hero-field' className='text-sm leading-7 text-gray-400'>
                                Placeholder
                            </label>
                            <input
                                type='text'
                                id='hero-field'
                                name='hero-field'
                                className='bg-opacity-40 w-full rounded border border-gray-700 bg-gray-800 px-3 py-1 text-base leading-8 text-gray-100 transition-colors duration-200 ease-in-out outline-none focus:border-indigo-500 focus:bg-transparent focus:ring-2 focus:ring-indigo-900'
                            />
                        </div>
                    ...
                    <div className='flex text-gray-300 md:flex-col lg:flex-row'>
                        ...
                        <button className='mt-0 ml-4 inline-flex items-center rounded-lg bg-gray-800 px-5 py-3 hover:bg-gray-700 hover:text-white focus:outline-none md:mt-4 md:ml-0 lg:mt-0 lg:ml-4'>
                            <svg
                                xmlns='http://www.w3.org/2000/svg'
                                fill='currentColor'
                                className='h-6 w-6'
                            ...
                            <span className='ml-4 flex flex-col items-start leading-none'>
                                <span className='mb-1 text-xs text-gray-400'>Download on the</span>
