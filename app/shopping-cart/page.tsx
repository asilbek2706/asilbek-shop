            ...
            {products.length ? (
                        ...
                        <div className='rounded-lg md:w-2/3'>
                            {products.map((product) => (
                                ...
                                >
                                    ...
                                    <div className='gap-x-4 sm:ml-4 sm:flex sm:w-full sm:justify-between'>
                ...
                <div className='flex h-[calc(100vh-80px)] w-full items-center justify-center bg-white p-5'>
                    <div className='text-center'>
                        ...
                        <Link href={'/products'}>
                            <button className='button mt-4 border-transparent bg-blue-600 text-white hover:border-blue-600 hover:bg-transparent hover:text-black'>
                                Products
                            </button>
                        </Link>
                    </div>
